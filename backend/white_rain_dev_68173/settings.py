"""
Django settings for white_rain_dev_68173 project.
...
ROOT_URLCONF = 'white_rain_dev_68173.urls'
...
WSGI_APPLICATION = 'white_rain_dev_68173.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_rain_dev_68173 API",
    "DESCRIPTION": "API documentation for white_rain_dev_68173 App",
    "VERSION": "v1",
}
